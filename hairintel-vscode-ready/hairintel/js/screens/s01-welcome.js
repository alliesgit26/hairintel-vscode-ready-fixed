  ...
  <div class="hi-screen hi-animate-fade" id="screen-welcome">
    ...
    <div style="padding:48px var(--pad) 32px; background:linear-gradient(180deg,#1A1508 0%,var(--bg) 100%);">
      ...
      <div style="text-align:center;margin-top:12px;">
        <span class="hi-label" style="color:var(--success);">${HIcons.check} ${hiCapitalize(sub.plan)} Plan Active</span>
      </div>
      `}
    </div>
    ...
    <div style="padding:0 var(--pad) 40px;">
      ...
      <div style="padding:40px 0;text-align:center;">
        ...
        <div style="font-size:13px;color:var(--text-muted);line-height:1.6;max-width:240px;margin:0 auto;">Start your first AI-powered hair extension consultation.</div>
      </div>
      `}
      ...
      <div class="hi-card-gold" style="cursor:pointer;" onclick="HIApp.go('subscription')">
        <div style="display:flex;align-items:center;gap:14px;">
          ...
          <div style="flex:1;">
            <div style="font-size:14px;font-weight:700;color:var(--text);margin-bottom:3px;">Upgrade to Pro</div>
            <div style="font-size:12px;color:var(--text-muted);">Unlimited consultations, PDF exports, saved client history</div>
          </div>
